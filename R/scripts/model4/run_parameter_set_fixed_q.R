...
get_previous_q_per_fam <- function(parameters){
  if(is.null(first_qualities)){
    qualities <- unique(prim_parameters[,c("fam_nr", "quality")])
  } else {
    qualities <- data.frame("fam_nr" = seq(nr_of_families),
                            "quality" = first_qualities)
  }
...
#-------------------------------------------------------------------------------
  ...
  ggsave(paste0(folder, run_name, "_plot_prim_sec_quality.png"), plot = plot_prim_sec_quality, 
...
#-------------------------------------------------------------------------------
  ...
  ggsave(paste0(folder, run_name, "_plot_sec_ter_quality.png"), plot = plot_sec_ter_quality, 
         width = 1300, height = 1500, units = "px")

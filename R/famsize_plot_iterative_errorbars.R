...
for (i in seq(1000)) {
  prim_parameters <- pick_parameters(bp_rule = 'runif(1, min = 0, max = 3.5)',
                                     ...
                                     t_start_dist = 'rlnorm(nr_of_families, meanlog = 1.4, sdlog = 0.25)',
...
sink(file = "./results/stats_iterative_errorbars_1000average.txt")
stats_means

stats_medians
sink(file = NULL)

sink(file = "./results/rawdata_iterative_errorbars_1000average.txt")
